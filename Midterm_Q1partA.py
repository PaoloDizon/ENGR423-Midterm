# -*- coding: utf-8 -*-
"""
Created on Mon Mar  2 20:29:56 2020
...
#    time.sleep(1)
    ...
    loco_drone.set_data(0, -10, 0)
    time.sleep(3)
    
#    loco_drone_JR.set_data(0, -10, 0)
#    time.sleep(3)
